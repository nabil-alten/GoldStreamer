(function (e, t, n, r) {
    ...
    var i = "strength",
        s = {
            ...
            strengthButtonText: "عرض كلمة المرور",
            strengthButtonTextToggle: "إخفاء كلمة المرور"
        };
    o.prototype = {
        init: function () {
            function c(e, t) {
            ...
            function p(t, n) {
                ...
                if (t <= 1) {
                    r.removeClass();
                    r.addClass("veryweak").html("ضعيف جدا")
                } else if (t == 2) {
                    r.removeClass();
                    r.addClass("weak").html("ضعيف")
                } else if (t == 3) {
                    r.removeClass();
                    r.addClass("medium").html("متوسط")
                } else {
                    r.removeClass();
                    r.addClass("strong").html("قوى")
                }
            }
            var t = 0;
            var r = 0;
